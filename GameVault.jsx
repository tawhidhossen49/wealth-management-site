...
const GAMES = [
  {
    ...
    color: "#00d4ff",
    accentColor: "#0099cc",
    img: "https://picsum.photos/seed/cyber2077/800/450",
    thumb: "https://picsum.photos/seed/cyber77/400/220",
    featured: true,
    new: false,
    hot: true,
  },
  {
    ...
    color: "#f59e0b",
    accentColor: "#d97706",
    img: "https://picsum.photos/seed/eldenring2/800/450",
    thumb: "https://picsum.photos/seed/elden01/400/220",
    featured: true,
    new: false,
    hot: false,
  },
  {
    ...
    color: "#ec4899",
    accentColor: "#be185d",
    img: "https://picsum.photos/seed/gtavi2024/800/450",
    thumb: "https://picsum.photos/seed/gta6/400/220",
    featured: true,
    new: true,
    hot: true,
  },
  {
    ...
    color: "#22c55e",
    accentColor: "#16a34a",
    img: "https://picsum.photos/seed/warzone3/800/450",
    thumb: "https://picsum.photos/seed/codwz/400/220",
    featured: false,
    new: false,
    hot: true,
  },
  {
    ...
    color: "#6c63ff",
    accentColor: "#4f46e5",
    img: "https://picsum.photos/seed/eafc24ultra/800/450",
    thumb: "https://picsum.photos/seed/eafc/400/220",
    featured: false,
    new: false,
    hot: false,
  },
  {
    ...
    color: "#a855f7",
    accentColor: "#9333ea",
    img: "https://picsum.photos/seed/baldurgate3/800/450",
    thumb: "https://picsum.photos/seed/bg3/400/220",
    featured: false,
    new: false,
    hot: false,
  },
  {
    ...
    color: "#0ea5e9",
    accentColor: "#0284c7",
    img: "https://picsum.photos/seed/starfield2/800/450",
    thumb: "https://picsum.photos/seed/starfd/400/220",
    featured: false,
    new: false,
    hot: false,
  },
  {
    ...
    color: "#ef4444",
    accentColor: "#dc2626",
    img: "https://picsum.photos/seed/diablo4dark/800/450",
    thumb: "https://picsum.photos/seed/d4/400/220",
    featured: false,
    new: false,
    hot: false,
  },
...
function LoadingScreen({ onDone }) {
  ...
  const phases = ["INITIALIZING...", "LOADING ASSETS...", "CALIBRATING UI...", "ENTERING VAULT..."];
    ...
    <div style={{
      ...
      <div style={{ width: 320, textAlign: "center" }}>
        ...
        <div className="rajdhani" style={{ color: COLORS.muted, fontSize: 13, letterSpacing: 3 }}>
          {phases[phase]} {Math.floor(progress)}%
        </div>
      </div>
    </div>
  );
  ...
  return (
    <nav style={{
      ...
      <div style={{ display: "flex", gap: 32, alignItems: "center" }}>
        {["Store", "Library", "Community", "Deals"].map(link => (
...
function FeaturedCarousel({ games, onAddToCart }) {
  ...
  return (
    <section style={{ padding: "0 32px 64px", maxWidth: 1400, margin: "0 auto" }}>
      <div style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ display: "flex", gap: 10 }}>
                <button onClick={() => onAddToCart(game)} style={{
                  flex: 1,
